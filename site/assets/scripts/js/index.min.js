...
//!!!!!!!!!!!!!!!!!!!!!!
console.timeEnd("SER_o.RESTORE__v")},REMOVE__v(e){SER_o.send__v("REMOVE",e)},INITIAL__v(e){window.localStorage.setItem("initial_b",e)}},IND_o={initial__v(){IND_o.unfold__v(),LIB_o.invisible__v(LIB_o.nodeId__o("initial"),"add"),IND_o.listen__v()},unfold__v(e){LIB_o.nodeId__o("section_docs")||(LIB_o.toggleId__v("sections_slider","aside"),IND_o.load__v())},load__v(e="sys",o="docs",t=-1,_=null){LIB_o.slot__v(e,o,t,((e,s)=>{s.dataset.slot_n=""+t,s.dataset.slot_s=o,_&&_(s),IND_o.listenSection__v(s),IND_o.toggleSection__v(s),setTimeout((()=>{LIB_o.invisible__v(s)}),20)})),IND_o.clearUrl__v()},colorMode__v(e,o){void 0===o&&(o="hue_base"===e?"220":"1"),window.localStorage.setItem(e,o),LIB_o.rootVar__v("--"+e,o),console.log(`Current ${e}: ${o}`)},service__v(){!1 in navigator?window.alert("To visit progressiVecontent, please use a browser with Service Workers enabled"):SER_o.init__v("https://progressivecontent.netlify.app/service_worker.min.js")},listen__v(){LIB_o.nodeId__o("sections_slider").addEventListener("click",(e=>{e.target?.closest("button")?.classList?.contains("step_focus")&&IND_o.unfold__v()}))},listenSection__v(e){e.querySelector("button[data-slot_s]").addEventListener("click",(()=>{e.querySelector("article[data-slot_s]").classList.toggle("retract")}))},toggleSection__v(e){e.querySelector("article[data-slot_s]").classList.toggle("retract"),e.scrollIntoView({behavior:"smooth",block:"start"})},clearUrl__v(){window.location.hash&&window.history.pushState({hash:window.location.hash.slice(1)},"progressiVecontent","https://progressivecontent.netlify.app/")}};!function(){LIB_o.rootVar__v("--HTML_OPAC","1"),IND_o.colorMode__v("hue_base"),IND_o.colorMode__v("lum_mode");if(!window.localStorage.getItem("initial_b"))return window.requestIdleCallback(IND_o.service__v),void LIB_o.nodeId__o("initial").addEventListener("click",(()=>{IND_o.initial__v()}));IND_o.initial__v()}();
