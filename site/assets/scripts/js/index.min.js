...
navigator.serviceWorker.register(e,{scope:"/"}).then((()=>{navigator.serviceWorker.onmessage=e=>SER_o.receive__v(e);const e=window.location.search;e&&SER_o.send__v("LOAD",e)}),(e=>console.log(`ServiceWorker registration failed [error: ${e}]`)))},send__v(e,o=null){navigator?.serviceWorker?.controller?.postMessage({type_s:e,payload_o:o})},receive__v(e){if(!e.data)return;const o=e.data.type_s;SER_o.types_a.includes(o)&&SER_o[o+"__v"](e.data.payload_o)},REGISTER__v(){window.localStorage.setItem("worker_b",!0)},RESTORE__v(e){
//!!!!!!!!!!!!!!!!!!!!!!
