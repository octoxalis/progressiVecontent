...
,
  ...
  ()
  {
    ...
    {
      return void window
        .alert( "To visit progressiVecontent, please use a Service Workers enabled browser" )
    }
    //>
    //--window
    //--  .requestIdleCallback
...
,
  ...
  (
    path_s='sys',
    slot_s='contents',
    slot_n=+'-1',          //: negative indices for C_o.SYS_s slots
    callback_f=null
  )
  {
    LIB_o
