...
// === PREF_o: preferences.js ===

var PREF_o =
{
  restore_b: true,    //: restore content slots on soft reload
  store_b:   true,    //: store page content as unique URL
}
...
,
  ...
  )
  {
    ...
    if ( doc_n >= 0 )    //: only for content slots
    {
      GRA_o
        .svg_e
...
,
  ...
  ()
  {
    ...
    {
      return void window
        .alert( "To visit progressiVecontent, you have to use a Service Workers enabled browser" )
    }
    //>
    //--window
    //--  .requestIdleCallback
...
,
  ...
  )
  {
    ...
    if ( !LIB_o.nodeId__o( 'section_contents' ) )  //: contents section not yet loaded
    {
      IND_o
...
,
  ...
  (
    path_s='sys',
    doc_s='contents',
    doc_n=+'-1',          //: negative indices for C_o.SYS_s slots
    callback_f=null
  )
  {
    LIB_o
